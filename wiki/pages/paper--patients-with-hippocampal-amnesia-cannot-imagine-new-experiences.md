...
**Type:** paper
**Slug:** patients-with-hippocampal-amnesia-cannot-imagine-new-experiences--hassabis
**Sources:** patients-with-hippocampal-amnesia-cannot-imagine-new-experiences--hassabis
...
## Connections- **Theme:** [theme--memory-imagination](pages/theme--memory-imagination.md), [theme--hippocampal-construction](pages/theme--hippocampal-construction.md) — this is the foundational empirical paper for both themes
...
## Honest Gaps
- The metadata in `_extraction_raw.json` lists venue as "Current-Biology" but the paper was published in PNAS (vol. 104, no. 5, pp. 1726–1731). The co-author list in metadata also omits Dharshan Kumaran and Seralynne D. Vann who appear on the paper.
- The PDF extraction contains scanning artefacts (reversed header/footer text on each page) but the body text is intact.
